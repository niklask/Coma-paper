...
position. The data were derived from the ring background model using a $0.2^{\circ}$ integration
radius.}
\label{fig:thetasq}
\end{figure*}
...
annihilation. $\alpha$ is the size ratio of the ON vs OFF source regions.}
...
\tablecolumns{4}
\tablewidth{0pc}
\tablecaption{Limits on the DM annihilation cross section times velocity $\expval{\sigma v}$
