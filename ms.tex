...
events for which only images from the two closest-spaced telescopes\footnote{In the arra
...
alos considered in this work are very similar to that in Figure \ref{fig:thetasq} and show no
...
shape the CR distribution and hence reflect the Bayesian priors that are imposed on the modelling
...
extended source, and three member galaxies. The flux upper limits obtained was then used to
