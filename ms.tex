...
acceleration. Protons should likewise be accelerated and, on account of
weak energy losses, can accumulate, suggesting that
clusters may also be sources of very high-energy (VHE; $E>100$ GeV) gamma-ray
emission. We
report here on VHE gamma-ray observations of the Coma galaxy cluster
with the VERITAS array of
imaging Cherenkov telescopes, with complementing \Fermi-LAT observations at
GeV energies. No significant gamma-ray emission from the Coma cluster was detected. Integral flux
upper limits at the 99\% confidence level were measured to be on the
order of $(2-5)\times 10^{-8}\ {\rm ph.\,m^{-2}\,s^{-1}}$ (VERITAS, $>220\ {\rm GeV}$) and $\sim 3\times 10^{-6}\ {\rm ph.\,m^{-2}\, s^{-1}}$
(\Fermi, $1-3\ {\rm GeV}$), respectively. We use the gamma-ray upper
limits to constrain CRs and magnetic fields in Coma. Using an analytical
approach, the CR-to-thermal pressure ratio is
...
$1-3\,\mu{\rm G}$, depending on the radial magnetic-field profile and on the gamma-ray
...
been used to place constraints on the thermally-averaged product of the total 
self-annihilation
cross section and the relative velocity of the DM particles, $\expval{\sigma v}$.
\end{abstract}
...
0 & 0.052 & 0.035 & 0.047 & 1.4 & 1.96\\
0.2 & 0.035 & 0.024 & 0.031 & 2.1 & 1.46\\
0.4 & 0.025 & 0.017 & 0.023 & 3.2 & 1.10\\
\enddata
\tablenotetext{a}{Intrinsic source radius (zero means point source), which is convolved with the
gamma-ray point-spread function.}
