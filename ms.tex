...
J. Dumm\altaffilmark{8},
G. Finnegan\altaffilmark{9},
L. Fortson\altaffilmark{8},
A. Furniss\altaffilmark{10},
N. Galante\altaffilmark{3},
G. Gyuk\altaffilmark{7},
P. Kaaret\altaffilmark{11},
N. Karlsson\altaffilmark{8,23},
D. Kieda\altaffilmark{9},
H. Krawczynski\altaffilmark{2},
G. Maier\altaffilmark{12},
P. Majumdar\altaffilmark{1},
S. McArthur\altaffilmark{2},
A. McCann\altaffilmark{13},
P. Moriarty\altaffilmark{14},
A. N. Otte\altaffilmark{15},
J. S. Perkins\altaffilmark{16,17},
M. Pohl\altaffilmark{18,12},
H. Prokoph\altaffilmark{12},
E. Roache\altaffilmark{3},
J. Ruppel\altaffilmark{18,12},
D. B. Saxon\altaffilmark{19},
G. H. Sembroski\altaffilmark{20},
C. Skole\altaffilmark{12},
I. Telezhinsky\altaffilmark{18,12},
G. Te\v{s}i\'{c}\altaffilmark{13},
S. Thibadeau\altaffilmark{2},
R. Welsing\altaffilmark{12}}

%%\email{nkarlsson@physics.umn.edu}
\and
\author{S. Federici\altaffilmark{12,18}, C. Pfrommer\altaffilmark{21,23},
A. Pinzke\altaffilmark{22}}
...
\altaffiltext{8}{School of Physics and Astronomy, University of Minnesota, Minneapolis, MN 55455, USA}
\altaffiltext{9}{Department of Physics and Astronomy, University of Utah, Salt Lake City, UT 84112, USA}
\altaffiltext{10}{Santa Cruz Institute for Particle Physics and Department of Physics, University of California, Santa Cruz, CA 95064, USA}
\altaffiltext{11}{Department of Physics and Astronomy, University of Iowa, Van Allen Hall, Iowa City, IA 52242, USA}
\altaffiltext{12}{DESY, Platanenallee 6, 15738 Zeuthen, Germany}
\altaffiltext{13}{Physics Department, McGill University, Montreal, QC H3A 2T8, Canada}
\altaffiltext{14}{Department of Life and Physical Sciences, Galway-Mayo Institute of Technology, Dublin Road, Galway, Ireland}
\altaffiltext{15}{School of Physics \& Center for Relativistic Astrophysics, Georgia Institute of Technology, 837 State Street NW, Atlanta, GA 30332-0430}
\altaffiltext{16}{CRESST and Astroparticle Physics Laboratory NASA/GSFC, Greenbelt, MD 20771, USA.}
\altaffiltext{17}{University of Maryland, Baltimore County, 1000 Hilltop Circle, Baltimore, MD 21250, USA.}
\altaffiltext{18}{Institut f\"ur Physik und Astronomie, Universit\"at Potsdam, 14476 Potsdam-Golm,Germany}
...
\altaffiltext{20}{Department of Physics, Purdue University, West Lafayette, IN 47907, USA }
\altaffiltext{21}{Heidelberg Institute for Theoretical Studies, Schloss-Wolfsbrunnenweg 35, D-69118 Heidelberg, Germany}
\altaffiltext{22}{Department of Physics, University of California, Santa Barbara, CA 93106, USA}
\altaffiltext{23}{Corresponding authors: N. Karlsson, nkarlsson@physics.umn.edu \& C. Pfrommer, christoph.pfrommer@h-its.org}
...
interactions of highly relativistic cosmic-ray (CR) hadrons with the intracluster gas. Reported
here are VHE gamma-ray observations of the Coma galaxy cluster with the VERITAS array of imaging
Cherenkov telescopes, with complementing \Fermi Gamma-ray Space Telescope observations at GeV
energies. No significant gamma-ray emission from the Coma cluster was detected. Flux upper limits
at the 99\% confidence level were measured to be on the order of $2-5\times 10^{-8}$ ph. m$^{-2}$
s$^{-1}$ (VERITAS, $>$220 GeV) and $\sim 3\times 10^{-6}$ ph. m$^{-2}$ s$^{-1}$ (\Fermi, 1-3
...
radio halo to be all secondaries from cosmic-ray interactions. We use the gamma-ray flux upper
limits to constrain the populations of CRs and magnetic fields in Coma. Using an analytical
approach informed by cosmological cluster simulations, the CR-to-thermal pressure is constrained
to be \C{$< 16\%$} from VERITAS data and $< 2.5\%$ from \Fermi data (averaged within the virial
...
halo. Finally, a constraint on the thermally averaged product of the total self-annihilation cross
section and the relative velocity of the dark-matter particles, $\expval{\sigma v}$, is derived
and found to be $\lesssim 10^{-21}$ cm$^{3}$ s$^{-1}$ for $m_{\chi}\gtrsim 1000$ GeV/c$^{2}$.
\end{abstract}
...
the charged pions to electrons and positrons,\footnote{A charged pion decays to a muon or antimuon,
  which subsequently decays to an electron or positron as well as neutrinos.} and the neutral pion
to gamma rays. Due to the low density of the ICM ($n_{\mathrm{ICM}}\sim 10^{-3}$ cm$^{-3}$), the
large size and the volume-filling magnetic fields in the ICM, CR hadrons will be confined in the
cluster on timescales comparable to or longer than the Hubble time
...
\citep[e.g.,][]{article:Ensslin_etal:2007}, \C{where the brackets indicate volume averages.} A very
...
\C{(99\%\ CL)} strongly depend on $\alpha$. This is due to the comparably large \C{energy range from
...
with \Fermi limits \C{(99\%\ CL)} depend only weakly on $\alpha$ \C{since the energy range at GeV
...
the virial radius (dotted lines). \C{This suggests a spectral index of $\alpha=2.1$ in the energy
...
energy intervals.  \C{Constraints on $X_\CR$} with the gamma-ray flux limit of \Fermi in the energy
...
limit of the relative CR pressure of \C{$X_{\CR}<0.112$} within 0.2$^{\circ}$ that translates to a limit
within the cluster virial radius of \C{$X_\CR<0.162$} (solid lines of Figure \ref{fig:xcr}).  This limit
...
more constraining by a factor of \C{1.6} in comparison to the simulation-based model which gives
...
\caption{Integral flux upper limits for Coma (this work, Tables~\ref{table:results} and
  \ref{table:fermi}) for different integration radii (\C{error bars} with different grey scales),
  \C{assuming that $\alpha=2.3$ except in the 1--3 GeV energy interval where $\alpha=2.1$ is
    adopted.}  These are compared to integrated spectra of the same energy interval and aperture,
  assuming the universal gamma-ray spectrum of clusters \citep[\C{lines with different grey
    scales,}][]{article:PinzkePfrommer:2010}. To guide the eye, we show the underlying universal
  integral energy distribution of pion decay gamma-rays, $E_\gamma F_\gamma(>E_\gamma)$, resulting
  from hadronic interactions of CRs and ICM protons (dotted). \C{For visualization purposes all
    photon fluxes are weighted with the smallest energy in each interval.} Note that the \Fermi
  limit for the energy interval of 1--3 GeV within the aperture of 0.4$^\circ$ is most
  constraining.}
\label{fig:spectrum}
\end{figure*}
...
\tablecolumns{6}
\tablewidth{0pc}
\tablecaption{Constraints on the relative CR pressure in the Coma cluster core (simplified, \C{isobaric} analytic
...
Fermi.} 
\tablenotetext{d}{\C{Ratio of flux upper limits ($F_{\rmn{UL}}$) to the integrated gamma-ray flux
 from the simulation-based analytic model: in VERITAS band above $E=220~\rmn{GeV}$ an $\alpha=2.3$ is 
 assumed for the U.L., and in \Fermi band between $E=1-3$ GeV an $\alpha=2.1$ is assumed for the U.L..}}
...
\tablenotetext{c}{Minimum relative CR pressure, $X_{\CR,\,\rmn{min}}$, in the hadronic model
  ...
  VERITAS and \Fermi constraints: for a given realization of the CR pressure (and a magnetic
  field model which is trivial here as we assume $B \gg B_\rmn{CMB}$), we can derive the radio flux
  as well as gamma-ray fluxes in various bands (1--3 GeV, $>220$ GeV).}
...
\tablenotetext{a}{The parameters of the magnetic field are the magnetic decline, $\alpha_B$, and the
  ...
  n_{\rmn{e}}(0)]^{\alpha_B}$. \C{In all cases we used the most constraining $\rmn{RoI}=0.4^\circ$, see
  Sect.~\ref{sec:B} for details.}}
\label{table:Bmin}
\end{deluxetable}
