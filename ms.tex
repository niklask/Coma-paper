...
gamma-ray emission. Observations of radio halos and relics in clusters are indicative efficient
acceleration processes and the gamma-ray emission is the result of highly relativistic
cosmic-ray protons and ions interacting with intracluster gas and magnetic fields. Reported
here are VHE gamma-ray observations of the Coma cluster of galaxies with the VERITAS array
of imaging Cherenkov telescopes, with complementing Fermi Gamma-ray Space Telescope
observations at GeV energies. No significant gamma-ray emission from the Coma cluster
was detected. Flux upper limits at the 99\% confidence level were measured to be on the order of $2-5\times 10^{-8}$ ph. m$^{-2}$ s$^{-1}$ (VERITAS, $>$220 GeV) and
$\sim 3\times 10^{-6}$ ph. m$^{-2}$ s$^{-1}$ ({\em Fermi}, 1-3 GeV), respectively. The limits are
two orders of magnitude higher than model-predicted minimum gamma-ray fluxes, which
assumes the radio-emitting electrons to be all secondaries from cosmic-ray interactions. 

The gamma-ray flux upper limits have been used to constrain the populations of cosmic-ray
particles and magnetic fields and in the Coma cluster of galaxies. Using a simplified analytical
approach, the relative cosmic-ray pressure, $X_{\mathrm{CR}}=\expval{P_{\CR}}/\expval{P_{\rmn{th}}}$,
is constrained to be smaller than 20\% from VERITAS data and smaller than 4\% from
{\em Fermi} data. 
The observations imply a lower limit on
the intra-cluster magnetic field on the order of a $\mu$G, depending on the magnetic decline
and gamma-ray spectral index. Finally, a constraint on the thermally averaged product of the total self-annihilation
