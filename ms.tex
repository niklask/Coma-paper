...
strong point sources have been subtracted. Shown are also the $0.2^{\circ}$ and $0.4^{\circ}$ radii
...
\end{center}
\caption{Distribution of significances for Figure \ref{fig:skymaps} and a sampling radius of
$0.2^{\circ}$. The line is a Gaussian fit to the data, with mean $\mu=-0.11\pm 0.0059$ and
standard deviation $\sigma=1.01\pm 0.003$.}
\label{fig:sigdist}
\end{figure*}
...
(arrows with different grey scales), assuming
