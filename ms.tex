...
%This is more constraining by 50\% in comparison to the model derived from simulations. (in comparison to a power law spectrum with $\alpha_\rmn{TeV} \sim 2.2$ down to a cutoff in the normalized momentum of 0.8)
