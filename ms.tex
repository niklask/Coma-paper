...
been used to place constraint on the thermally averaged product of the total self-annihilation cross
section and the relative velocity of the DM particles, $\expval{\sigma v}$. This is found
to be about $10^{-20} - 10^{-21}$ cm$^{3}$ s$^{-1}$ for $m_{\chi} = 300$ GeV/c$^{2}$.
\end{abstract}
...
this end, we de-project the fit to the surface brightness profile of Eq. \ref{beta} (using an Abel
...
$\rmn{RoI}=0.4^\circ$, see \S~\ref{sec:B} for details.}  
\label{table:Bmin}
\end{deluxetable}
