...
a function of radial distance from the center of the Coma cluster. Model predictions are shown by
dashed lines \citep{article:PinzkePfrommer:2010} while these are scaled to match the most
