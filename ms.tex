...
A third mechanism for gamma-ray production in a galaxy cluster is self-annihilation of a dark matter particle, e.g. a weakly interacting massive particle (WIMP). This is particularly compelling because of the large amount of dark matter in a galaxy cluster.
...
\tablehead{
\colhead{Spatial model} & \multicolumn{3}{c}{S[$\sigma$]} & \multicolumn{3}{c}{Flux U.L.} \\
