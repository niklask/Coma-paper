...
Galaxy clusters have for many years been proposed as sources of gamma rays. If shock acceleration in
the ICM is an efficient process, a population of highly relativistic CR protons and heavy ions is to
...
time. Already a very modest CR-to-thermal pressure fraction, $X_\CR=\expval{P_{\CR}}/
\expval{P_{\mathrm{th}}}$, of a few per cent implies an observable flux of high-energy gamma rays
\citep[e.g.,][]{article:PfrommerEnsslin:2004b}. For a given CR distribution function, the
hadronically induced gamma-ray flux is directly proportional to $X_{\CR}$.
...
at $R_{500}$ -- the radius within which the mean density is 500 times the critical density --
...
gamma-ray spectrum for the Coma cluster is expected to be hard, photon index of about 2.3
